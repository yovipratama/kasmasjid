<?php namespace App\Http\Controllers;
	...
	class AdminMsBahanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Satuan","name"=>"id_satuan","join"=>"satuan,nama"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Satuan','name'=>'id_satuan','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'satuan,nama'];
