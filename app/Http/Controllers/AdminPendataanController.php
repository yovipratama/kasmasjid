<?php namespace App\Http\Controllers;
	...
	class AdminPendataanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ['label'=>'Infaq Harian Kotak','name'=>'kotak_harian','type'=>'money','validation'=>'required','width'=>'col-sm-10'];

			$masuk_dana[] = ['label'=>'Uraian','name'=>'uraian','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$masuk_dana[] = ['label'=>'Kotak Harian','name'=>'kotak_harian','type'=>'radio','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'1;0'];
			...
			$this->form[] = ['columns'=>$masuk_dana,'label'=>'Pemasukan Dana','name'=>'masuk_dana','type'=>'child','width'=>'col-sm-10','table'=>'masuk_dana','foreign_key'=>'id_tanggal'];
			...
			$this->form[] = ['columns'=>$masuk_bahan,'label'=>'Wakaf Bahan','name'=>'masuk_bahan','type'=>'child','width'=>'col-sm-10','table'=>'masuk_bahan','foreign_key'=>'id_tanggal'];
			...
			$this->form[] = ['columns'=>$keluar_dana,'label'=>'Pengeluaran Dana','name'=>'keluar_dana','type'=>'child','width'=>'col-sm-10','table'=>'keluar_dana','foreign_key'=>'id_tanggal'];
			...
			//$this->form[] = ['label'=>'Tanggal','name'=>'tanggal','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			//
			//$harian[] = ['label'=>'Uraian','name'=>'uraian','type'=>'hidden','value'=>"Infaq Harian Kotak"];
			//$harian[] = ['label'=>'Jumlah','name'=>'jumlah','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$harian[] = ['label'=>'Via','name'=>'via','type'=>'hidden','value'=>"cash"];
			//$harian[] = ['label'=>'Kotak Harian','name'=>'kotak_harian','type'=>'hidden','value'=>'1'];
			//$this->form[] = ['columns'=>$harian,'label'=>'Infaq Harian Kotak','name'=>'infaq_harian','type'=>'child','width'=>'col-sm-10','table'=>'masuk_dana','foreign_key'=>'id_tanggal'];
			//
			//$masuk_dana[] = ['label'=>'Uraian','name'=>'uraian','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$masuk_dana[] = ['label'=>'Jumlah','name'=>'jumlah','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$masuk_dana[] = ['label'=>'Via','name'=>'via','type'=>'radio','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'cash;bank'];
