...
<div class="box">
	<div class="box-header">  
		<div class="pull-left">     
			<div style="display:inline-grid">Pilih Rentang Jumat Tertentu : </div>
			<div class="input-group" style="display:inline-grid">
                <select onchange="showHide(this.value);" name="limit" class="form-control input-sm" id="tgl">
					...
					<?php
						...
						$i++;
					?>
                    <option value="{{$i}}">{{$mulai}} - {{$wk}}</option>
					@endforeach
                </select>                              
			</div>		
        </div><!--end-pull-left-->
	...
	<div class="box-body table-responsive no-padding">
		<table id="table_dashboard" class="table table-hover table-striped table-bordered">
			<thead>
				...
				<tr class="active">           
					<th width="auto" rowspan=2 style="border:1px solid #ddd;text-align:center">Periode</th>   
	...
	<div class="box-body table-responsive no-padding">
		<table id="table_dashboard" class="table table-hover table-striped table-bordered">
			<thead>
				...
				<tr class="active">           
					<th width="auto" style="border:1px solid #ddd;text-align:center">Periode</th>   
