...
<script>print()</script>
@endif
<h2 style="text-align:center;margin:0;margin-bottom:5px;font-size:1.4em" width="100%">Penerimaan dan Pengeluaran <u>Jum'atan</u> Dana/Bahan Masjid Darussalam</h2>
...
<table border='1' width='100%' cellpadding='3' cellspacing="0" style='border-collapse: collapse;font-size:12px'>
			<thead>
				...
				<tr class="active">           
					<th width="auto" rowspan=2 style="text-align:center">Periode</th>   
			...
			<tbody>
				...
				@foreach($waktu as $w)
					...
					<tr class="all all{{$i}} sebelum danger">
						<td colspan=7 style="font-weight:bold">Saldo Jumat Sebelumnya</td>
					...
					@endforeach					
						<tr class="all all{{$i}} danger">
							<td colspan=2 style="font-weight:bold">Saldo Jumat Ini</td>
...
<table border='1' width='100%' cellpadding='3' cellspacing="0" style='border-collapse: collapse;font-size:12px'>
			<thead>
				...
				<tr class="active">           
					<th width="auto" style="text-align:center">Periode</th>   
			...
			<tbody>
				...
				@foreach($waktu as $w)
					...
					@if($i>1)
					<tr class="all all{{$i}} sebelum danger">
						<td colspan=5 style="font-weight:bold">Saldo Jumat Sebelumnya</td>
						<td style="text-align:right;font-weight:bold">{{ number_format($saldo,null,null,".")}}</td>
					</tr>
					@endif
					@foreach($ym as $md)
