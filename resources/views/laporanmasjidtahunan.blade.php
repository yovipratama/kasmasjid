...
<div class="box">
	<div class="box-header">  
		<div class="pull-left">     
			<div style="display:inline-grid">Pilih Tahun Tertentu : </div>
	...
	<div class="box-body table-responsive no-padding">
		<table id="table_dashboard" class="table table-hover table-striped table-bordered">
			<thead>
				...
				<tr class="active">           
					<th width="auto" rowspan=2 style="border:1px solid #ddd;text-align:center">Tahun</th>   
			...
			<tbody>
				...
				@foreach($waktu as $w)
					...
					<tr class="all all{{$i}} sebelum danger">
						<td colspan=7 style="font-weight:bold">Saldo Tahun Sebelumnya</td>
					...
					@endforeach					
						<tr class="all all{{$i}} danger">
							<td colspan=2 style="font-weight:bold">Total Tahunan</td>
		...
		<table id="table_dashboard" class="table table-hover table-striped table-bordered">
			...
			<tbody>
				...
				@foreach($waktu as $w)
					...
					@if($i>1)
					<tr class="all all{{$i}} sebelum danger">
						<td colspan=5 style="font-weight:bold">Saldo Tahun Sebelumnya</td>
						<td style="text-align:right;font-weight:bold">{{ number_format($saldo,null,null,".")}}</td>
					</tr>
					@endif
					@foreach($ym as $md)
