...
<div class="box">
	...
	<div class="box-body table-responsive no-padding">
		<table id="table_dashboard" class="table table-hover table-striped table-bordered">
			<thead>
				<tr class="active">           
					<th width="auto" rowspan=2 style="border:1px solid #ddd;text-align:center">Mulai</th>   
					<th width="auto" rowspan=2 style="border:1px solid #ddd;text-align:center">Sampai</th>   
